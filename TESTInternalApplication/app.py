...
app = Flask(__name__)
app.secret_key = '123456'  # Replace with your secret key
...
def submit_form():
    try:
        ...
        # Delete all records from the FormEntry table
        # FormEntry.query.delete()

        # Commit the changes to clear the database
        # db.session.commit()
...
@app.route('/success')
def success():
    # Display a success message or any other content you want
    return render_template('Flask.html')
