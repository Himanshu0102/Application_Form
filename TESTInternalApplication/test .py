...
def submit_form():
    try:
        ...
        # return render_template('Flask.html', tasks=FormEntry.query.all(), success_message=success_message)
        # return render_template('Flask.html', success_message=success_message)

    except Exception as e:
        print(f"Error: {e}")
        db.session.rollback()
        return jsonify({'success': False,'message': 'Error submitting form data'})
